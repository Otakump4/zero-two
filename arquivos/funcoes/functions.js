...
const banner2 = cfonts.render((`Canal: https://youtube.com/@Otaku.mp4\nDesenvolvedor Oficial: @lucas_mod_domina`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`ZERO TWO|V8`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "Zero Two Multi-Device"
const packname = "Criador: @lucas_mod_domina"

const chyt = "559491569380@s.whatsapp.net";
const nit = "559491569380@s.whatsapp.net";
const supre = "559491569380@s.whatsapp.net";
